"""
Remote AI Jobs connector — pulls from the Real Work From Anywhere AI-specific
category feed. This is a narrower, higher-signal feed than the main RWFA feed,
targeting ML, LLM, AI engineering, and data science roles specifically.
"""
import traceback
...
logger = setup_logger("remoteaijobs_connector")
...
class RemoteAIJobsConnector(BaseConnector):
    ...
    def _parse_item(self, item) -> Dict[str, Any] | None:
        ...
        # Titles: "Job Title at Company Name"
        if " at " in title_raw:
    ...
    def normalize(self, raw_job: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "remote_eligibility": "accept",  # RWFA only lists worldwide-remote
        }
